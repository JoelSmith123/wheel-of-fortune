class BonusRound extends Round {
  ...
  populateBonusLettersToScreen() {
    ...
    // push r, s, t, l, e to puzzle.lettersGuessed
  }

  checkBonusLetters(letterArray) {
    // accepts an array of 3 consonants and a vowel
    // push letterArray to puzzle.lettersGuessed
    // run on submit event
  }

  spinBonusWheel() {
    // calling a new Wheel, passing in bonusWheelPrizes array
